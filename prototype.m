...
% Last Modified by GUIDE v2.5 14-Jan-2022 12:55:18
...
h=handles.axes8
imshow('/Users/aliffazfar/Desktop/FYPResources/logo.bmp','parent',h); % uitm logo
axis image
...
global imgrsz; %declare the ihe selected image 
fullFileName = fullfile(folder, baseFileName);
set(handles.edit13, 'String', fullFileName); %show the ihe image filepath

myImage = imread(fullFileName);
imgrsz = imresize(myImage, [512 512]); %resize the selected image
axes(handles.axes1);
imshow(imgrsz);
axis image;
...
drawnow; %immediately updates figures and callback
...
filename = 'NewData.xlsx'; %save into xlsx for testing with trained dataset
...
waitbar(.67,f,'Calculating cross-validation accuracy');
pause(1.4)
...
edit12(2, 1, 'normal text', 'Color', my_color);
opacity = 0.4; % 40 percent visible = mainly transparent
edit12(2, 1.5, 'kinda transparent text', 'Color', (1 - opacity * (1 - my_color)));
